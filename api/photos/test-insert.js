/**
 * POST /api/photos/test-insert
 * Debug endpoint: Insert a test row into Photo table
 * Admin-protected
 */
...
export default async function handler(req, res) {
  try {
    ...
    const photo = await prisma.photo.create({
      data: {
        originalName: "test-insert.png",
        mimeType: "image/png",
        size: 0,
        blobUrl: "https://example.com/test.png",
        createdAt: new Date(),
      },
    });

    console.log(`TEST_INSERT_OK ${photo.id}`);
